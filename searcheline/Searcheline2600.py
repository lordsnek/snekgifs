...
class Search100(Searcheline):
  ...
  def init_state(self):
    ...
    #utils.place_maddy(self.p8, 91, 96, 0.31041, 0.498535, 1, -0.53006, 0, 1)
  ...
  def is_goal(self, objs):
    ...
    return p and p.y==80 and p.spd.y+p.rem.y>-.5 #and p.djump>0 #Be at the height of the final cloud, without going far to the right
  ...
  def allowable_actions(self, objs, player, h_movement, can_jump, can_dash):
    ...
    if can_dash:
      actions.extend([0b101010,0b100010,0b100100]) # u + x, u + l + x
    return actions
