...
class Search100(Searcheline):
  ...
  def init_state(self):
    ...
    utils.place_maddy(self.p8, 55, 40, -.4, -0.130408, 0, -2.79, 0, 2)
  ...
  #def is_goal(self, objs):
    ...
    #return p and p.y<-4 #and p.djump>0 #Be at the height of the final cloud, without going far to the right
...
if __name__ == '__main__':
  ...
  s = Search100()
  solutions = s.search(25,complete=False)
