...
class Search100(Searcheline):
  ...
  def is_goal(self, objs):
    ...
    return p and (p.spd.y<-2.78 and p.spd.y>-2.8) #Be at the height of the final cloud, without going far to the right
  ...
  def allowable_actions(self, objs, player, h_movement, can_jump, can_dash):
    ...
    if can_dash:
      actions.extend([0b100010, 0b100110, 0b101010]) # u + x, u + l + x
    return actions
